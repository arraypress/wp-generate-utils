...
class Generate {
	...
	/**
	 * Generate human-readable IDs (like Docker container names).
	 *
	 * @param string $separator   Separator between words (default: '-').
	 * @param bool   $with_number Include number suffix (default: true).
	 *
	 * @return string Readable ID like "happy-tiger-42".
	 */
	public static function readable_id( string $separator = '-', bool $with_number = true ): string {
		$adjectives = [
			'happy',
			'brave',
			'bright',
